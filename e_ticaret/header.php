...
<head>
	...
	<meta name="description" content="<?php echo  $ayarcek['ayar_tittle']; ?>">
...
<body>
	<div id="wrapper">
		<div class="header"><!--Header -->
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-md-3 main-logo">
						<a href="index.php"><img width="100" height="50" src="<?php echo $ayarcek['ayar_logo'] ?>" alt="Site Logosu" class="logo img-responsive"></a>
					</div>
					...
					<div class="col-md-9">
						<div class="pushright">
							...
							<div class="top">
								...
								<?php  } else { ?> <a href="#" class="btn btn-default btn-dark">Hoşgeldin<span>--</span><?php echo $kullanicicek['kullanici_adsoyad'] ?></a> 
								...
								<div class="regwrap">
									<div class="row">
										...
										<div class="col-md-6">
											...
											<p>
												Yeni kullanıcı mısın ? Alış-Verişe başlamak için hemen KAYIT OL
											</p>
											<a href="register"><button class="btn btn-default btn-yellow">Şimdi Kaydol</button></a>
										</div>
									</div>
								</div>
