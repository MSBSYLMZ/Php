			...
			<div class="col-md-6">
				...
				<div class="form-group dob">
					<div class="col-sm-12">
						...
						<input type="text" class="form-control"  required="" name="kullanici_adsoyad" placeholder="Ad ve Soyadınızı Giriniz..." value=" <?php echo $kullanicicek['kullanici_adsoyad'] ?>">
					</div>
					
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<input type="email" class="form-control" required="" name="kullanici_mail"  placeholder="Dikkat! Mail adresiniz kullanıcı adınız olacaktır." value=" <?php echo $kullanicicek['kullanici_mail'] ?>">
					</div>
				</div>
				<div class="form-group dob">
					<div class="col-sm-6">
				...
				<button type="submit" name="hesabimduzenle" class="btn btn-default btn-red">Düzenle</button>
			</div>
			<div class="col-md-6">
				<div class="title-bg">
